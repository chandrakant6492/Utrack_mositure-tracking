...
def MR_footprint_backward(month, latitude, longitude):
...
def absolute_backward_tracking(Screened_data):
    ...
    for j in tqdm(range(Screened_data.shape[0])):
        ...
        for i in range(12):
            Evap_footprint_monthly[i,:,:] = MR_footprint_backward(i+1,latitude,longitude)
...
"""
Evap_footprint_monthly_sum = absolute_backward_tracking(Screened_data)
...
ax[0].set_title('Backwardtracking: mm/year')


"""
6. Save the dataset 
"""
#Evap_footprint_monthly_sum.to_netcdf('/home/chandra/Current/Paper-4/test_backwardtracking.nc')
